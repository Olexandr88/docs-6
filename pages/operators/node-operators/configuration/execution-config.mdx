...
<Tabs items={['Syntax', 'Example', 'Environment Variable']}>
  ...
  <Tabs.Tab>`--discovery.v4=false`</Tabs.Tab>
  <Tabs.Tab>`GETH_DISCOVERY_V4=false`</Tabs.Tab>
</Tabs>
...
<Tabs items={['Syntax', 'Example', 'Environment Variable']}>
  ...
  <Tabs.Tab>`--discovery.v5=true`</Tabs.Tab>
  <Tabs.Tab>`GETH_DISCOVERY_V5=true`</Tabs.Tab>
</Tabs>
